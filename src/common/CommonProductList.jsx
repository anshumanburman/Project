...
export default class CommonProductList extends Basecomponents {
    ...
    render() {
        ...
        return (
            <View>
                <Ripple style={{ flex: 1,paddingVertical:10}}
                    onPress={onPress} >
                    <View style={{ flexDirection: 'row', flex: 1 }}>
                        <View style={{ alignItems: 'center', flexDirection: 'row', flex: isDelte ? .9 : 1, paddingVertical: 5, paddingHorizontal: DIMENS.px_5}}>
                            <Image source={item.imageLocations&&item.imageLocations!=''?{url:item.imageLocations}:SHOP_CART} style={{ width: WIDTH * 20 / 100, height: 70,
                ...
                </Ripple>
                {
                    ...
                    <Ripple style={{
                        ...
                        <Image source={DELETE} style={{ width: 30, height: 20 }} resizeMode={'contain'} />
                    </Ripple>
                }
            </View>
        )
